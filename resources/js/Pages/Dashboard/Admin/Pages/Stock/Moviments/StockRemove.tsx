...
const StockOut: React.FC<StockEntryFormProps> = () => {
  ...
  return (
    <AdminLayout>
      <Head title="Registrar Movimento de Saida de Estoque" />
      <div className="container mx-auto p-6">
        <h2 className="text-2xl font-semibold mb-4">Registrar Movimento de Saida de Estoque
          ...
          */}
          ...
          <div className="flex justify-end">
            <button
              ...
              disabled={processing}
            >
              {processing ? 'Registrando...' : 'Registrar Saida'}
            </button>
